...
import { List, Form, TextArea, Input, Button, Icon } from 'semantic-ui-react'
    ...
    render() {
        ...
        return (
            ...
            <List horizontal relaxed size='large' selection>
                ...
                onClick={this.handleItemClick}>
                <label><i class="fas fa-cloud"></i></label>
                ...
                onClick={this.handleItemClick}>
                <label><i class="fas fa-umbrella"></i></label>
                ...
                onClick={this.handleItemClick}>
                <label><i class="fas fa-snowflake"></i></label>
                ...
                onClick={this.handleItemClick}>
                <label><i class="fas fa-temperature-low"></i></label>
                ...
                onClick={this.handleItemClick}>
                <label><i class="fas fa-thermometer-full"></i></label>
                <List.Content><List.Header as='a'>Humid</List.Header>
                    ...
                    <Button inverted icon labelPosition='right' type="submit"><Icon name='save' />SAVE MOOD</Button>
                
                   
                </Form> 
                
                <i className={`far fa-2x ${this.state.feeling}`}></i>{this.state.feeling}
                <i className={`fas fa-2x ${this.state.weather}`}></i>{this.state.weather}
